            ...
            <div class="perfil-body">
                <div class="datos">
                    ...
                    <form method="POST" onsubmit="return validarFormDatos()" action="{{ route('editarDatos', [$id]) }}">
                        ...
                        <input type="text" id="formNombre" class="formNombre" name="formNombre"
                            value="<?php echo $user_name; ?>" readonly><br><br>
                        ...
                        <input type="text" id="formApe" class="formApe" name="formApe" value="<?php echo $user_surname; ?>"
                            readonly><br><br>
                        ...
                        <input type="text" id="formTel" class="formTel" name="formTel" value="<?php echo $user_tel; ?>"
                            readonly><br><br>
                ...
                <div class="cuenta">
                    ...
                    <form method="POST" onsubmit="return validarFormCuenta()" action="{{ route('editarCuenta', [$id]) }}">
                        ...
                        <input type="text" id="formEmail" class="formEmail" name="formEmail" value="<?php echo $user_email; ?>"
                            readonly><br><br>
                        ...
                        @enderror
                        <div class="password">
                            <input type="password" id="formContra" class="formContra" name="formContra"
                                placeholder="Nueva contraseña" readonly><br><br>
